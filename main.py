...
def contains_keywords(text: str) -> bool:
    ...
    has_ua_banks = any(w in t for w in UA_BANKS)
    has_usdt = any(w in t for w in USDT)

    if has_buy_sell and has_ua_banks:
        return True

    if has_buy_sell and has_usdt:
        return True
...
# ================= START =================
print("Discord → Telegram bot started (SMART FILTER + грн)")
