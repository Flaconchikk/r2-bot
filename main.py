...
UA_WORDS = [
    "грн", "гривн", "укр", "укра", "банк", "банки"
]

USDT_WORDS = ["usdt", "юсдт"]

# nкк patterns: 1кк, 10 кк, 250кк etc.
...
def contains_keywords(text: str) -> bool:
    ...
    # логика:
    # куплю/продам + nкк + (грн / укр / укр банк / usdt / юсдт)
    return has_trade and has_kk and (has_ua or has_usdt)
...
# ================= START =================
print("Bot started (KK + USDT support enabled)")
